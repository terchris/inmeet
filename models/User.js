...
User.add({
	...
	groups: { type: Types.Relationship, ref: 'Group',  many: true , label: 'Groups'}
}, 'Skills', {
	skills: {
		business: { type: Boolean, label: 'Business development'},
		design: { type: Boolean , label: 'Design'},
		development: { type: Boolean, label: 'Development / programming' }
	}
}, 'Mentoring', {
	mentoring: {
